...
function_signature(void, BUFset_on_post_resize, void (*on_post_resize)(void)) { buf_set_on_post_resize(binded_buffer, on_post_resize); }
...
function_signature(void, BUFset_on_pre_resize, void (*on_pre_resize)(void)) { buf_set_on_pre_resize(binded_buffer, on_pre_resize); }
...
function_signature(void, BUFpush_pseudo, buf_ucount_t count) { buf_push_pseudo(binded_buffer, count); }
...
function_signature(void, BUFpop_pseudo, buf_ucount_t count) { buf_pop_pseudo(binded_buffer, count); }
...
function_signature(void, BUFinsert_pseudo, buf_ucount_t index, buf_ucount_t count) { buf_insert_pseudo(binded_buffer, index, count); }
...
function_signature(void, BUFremove_pseudo, buf_ucount_t index, buf_ucount_t count) { buf_remove_pseudo(binded_buffer, index, count); }
...
function_signature(void, BUFset_auto_managed, bool value) { buf_set_auto_managed(binded_buffer, value); }
...
function_signature_void(buf_ucount_t, BUFget_offset) { return buf_get_offset(binded_buffer); }
...
function_signature_void(buf_ucount_t, BUFget_capacity) { return buf_get_capacity(binded_buffer); }
...
function_signature_void(buf_ucount_t, BUFget_element_count) { return buf_get_element_count(binded_buffer); } 
...
function_signature_void(buf_ucount_t, BUFget_element_size) { return buf_get_element_size(binded_buffer); }
...
function_signature_void(void*, BUFget_ptr) { return buf_get_ptr(binded_buffer); }
...
function_signature(void, BUFset_offset, buf_ucount_t offset) { buf_set_offset(binded_buffer, offset); }
...
function_signature(void, BUFset_capacity, buf_ucount_t capacity) { buf_set_capacity(binded_buffer, capacity); }
...
function_signature(void, BUFset_element_count, buf_ucount_t element_count) { buf_set_element_count(binded_buffer, element_count); }
...
function_signature(void, BUFset_element_size, buf_ucount_t element_size) { buf_set_element_size(binded_buffer, element_size); }
...
function_signature(void, BUFset_ptr, void* ptr) { buf_set_ptr(binded_buffer, ptr); }
...
function_signature_void(bool, BUFis_auto_managed) { buf_is_auto_managed(binded_buffer); }
...
function_signature_void(void, BUFlog) { buf_log(binded_buffer); }
...
function_signature_void(static bool, BUFis_stack_allocated) { return buf_is_stack_allocated(binded_buffer); }
function_signature(static bool, buf_is_stack_allocated, BUFFER* buffer)
{
	GOOD_ASSERT(buffer != NULL, "Buffer Is NULL Exception");
...
function_signature_void(static bool, BUFis_heap_allocated) { return buf_is_heap_allocated(binded_buffer); }
function_signature(static bool, buf_is_heap_allocated, BUFFER* buffer)
{
	GOOD_ASSERT(buffer != NULL, "Buffer Is NULL Exception");
...
function_signature_void(void, BUFfree) { buf_free(binded_buffer); }
...
function_signature(void, BUFmove_to, BUFFER* destination) { buf_move_to(binded_buffer, destination); }
...
function_signature(void, BUFcopy_to, BUFFER* destination) { buf_copy_to(binded_buffer, destination); }
...
function_signature(void, BUFset_on_free, void (*free)(void*)) { buf_set_on_free(binded_buffer, free); }
...
function_signature(void, BUFget_at, buf_ucount_t index, void* out_value) { buf_get_at(binded_buffer, index, out_value); }
...
function_signature(void*, BUFgetptr_at, buf_ucount_t index) { return buf_getptr_at(binded_buffer, index); }
...
function_signature(void, BUFset_at, buf_ucount_t index , void* in_value) { buf_set_at(binded_buffer, index, in_value); }
...
function_signature_void(void*, BUFget_offset_bytes) { return buf_get_offset_bytes(binded_buffer); }
...
function_signature(void, BUFset_offset_bytes, void* offset_bytes) { buf_set_offset_bytes(binded_buffer, offset_bytes); }
...
function_signature_void(buf_ucount_t, BUFget_buffer_size) { return buf_get_buffer_size(binded_buffer); }
...
function_signature(void, BUFresize, buf_ucount_t new_capacity) { buf_resize(binded_buffer, new_capacity); }
...
function_signature(void, BUFclear_buffer, void* clear_value) { buf_clear_buffer(binded_buffer, clear_value); }
...
function_signature(void, BUFclear, void* clear_value) { buf_clear(binded_buffer, clear_value); }
...
function_signature(void, BUFinsert_at_noalloc, buf_ucount_t index , void* in_value , void* out_value) { buf_insert_at_noalloc(binded_buffer, index, in_value, out_value); }
...
function_signature(void, BUFinsert_at, buf_ucount_t index , void* in_value) { buf_insert_at(binded_buffer, index, in_value); }
...
function_signature(bool, BUFremove_at_noshift, buf_ucount_t index , void* out_value) { return buf_remove_at_noshift(binded_buffer, index, out_value); }
...
function_signature(bool, BUFremove_at, buf_ucount_t index , void* out_value) { return buf_remove_at(binded_buffer, index, out_value); }
...
function_signature(bool, BUFremove_noshift, void* object, bool (*comparer)(void*, void*)) { return buf_remove_noshift(binded_buffer, object, comparer); }
...
function_signature(bool, BUFremove, void* object, bool (*comparer)(void*, void*)) { return buf_remove(binded_buffer, object, comparer); }
function_signature(bool, buf_remove, BUFFER* buffer, void* object, bool (*comparer)(void*, void*))
{
	GOOD_ASSERT(buffer != NULL, "buffer is NULL Exception");
	GOOD_ASSERT(buffer->element_count > 0, "Buffer is Empty!");	
	void* cursor = buffer->bytes; 
	for(int i = 0; i < buffer->element_count; i++, cursor += buffer->element_size)
	{
		if(comparer(object, cursor))
		{
...
function_signature_void(void, BUFfit) { buf_fit(binded_buffer); }
...
function_signature_void(void*, BUFpeek_ptr) { return buf_peek_ptr(binded_buffer); }
...
function_signature(void, BUFpeek, void* out_value) { buf_peek(binded_buffer, out_value); }
...
function_signature(void, BUFpop, void* out_value) { buf_pop(binded_buffer, out_value); }
...
function_signature(buf_ucount_t, BUFfind_index_of, void* value, bool (*comparer)(void*, void*)) { return buf_find_index_of(binded_buffer, value, comparer); }
...
function_signature(void, BUFpush, void* in_value) { buf_push(binded_buffer, in_value); }
